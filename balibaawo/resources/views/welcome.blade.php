...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="shortcut icon" href="images/bali1-logo.jpeg">
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="container has-feedback">
                <!-- logo -->
                <div class="logo pull-left"><a href="#"></a><img class="img-responsive" src="/images/bali-logo.jpeg" title="Balibaawo Logo" width="100" height="100" >
                </div>
                <!-- Top Contact us -->
                <div class="holder">
        ...
        <div class="container"> <!-- main content goes here -->
            <div class="content">
                @yield('content')
            </div>
        </div>
                    ...
                    <div class="row holder">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-">
                            ...
                            <ul class="social-networks"> <!-- TO DO: add link balibaawo to facebook page-->
                                <li><a href="" target="blank" class="fa fa-facebook">Facebook</a></li>
                            </ul>
                        </div> <!-- end of column_1 -->
                     ...
                     <div class="infobar">
                            <div class="container has-feedback">
                                ...
                                <p>&copy; Balibaawo Nursing Home</p>
                            </div>
                    </div>
                </div>
